    ...
    <>
      <section className="text-center mb-8">
        ...
        <p className="text-muted text-base sm:text-lg max-w-xl mx-auto">
          양도소득세 · 취득세 · 종부세 · 임대소득세를 쉽고 빠르게 계산하세요.
        </p>
      </section>
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "매년 6월 1일 기준 공시가격 합산액이 주택 9억원(1세대 1주택 12억원), 토지 5억원을 초과하면 납부 대상입니다.",
                },
              },
              {
                "@type": "Question",
                name: "임대소득세 분리과세가 유리한가요?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "연간 주택 임대 수입 2,000만원 이하이면 14% 분리과세를 선택할 수 있습니다. 다른 소득이 많으면 분리과세가 유리합니다.",
                },
              },
            ],
          }),
